...
* 🟢 [Genesis](https://genesis-world.readthedocs.io) - Generative and universal physics platform for robotics with GPU-accelerated parallel simulation. [⭐ 29.4k](https://github.com/Genesis-Embodied-AI/Genesis) ⭐ 29,772 | 🐛 122 | 🌐 Python | 📅 2026-08-19
...
* 🟢 [MuJoCo](https://mujoco.org/) - Multi-joint dynamics with contact for physics-based simulation and control. [⭐ 14k](https://github.com/google-deepmind/mujoco) ⭐ 14,596 | 🐛 350 | 🌐 C++ | 📅 2026-08-19
* 🟢 [Newton](https://newton-physics.github.io/newton/) - GPU-accelerated differentiable physics engine built on NVIDIA Warp for robotics simulation. [⭐ 5.1k](https://github.com/newton-physics/newton) ⭐ 5,487 | 🐛 386 | 🌐 Python | 📅 2026-08-19
...
* 🟢 [Drake](https://drake.mit.edu/) - Planning, control, and analysis toolbox for nonlinear dynamical systems. [⭐ 4.1k](https://github.com/RobotLocomotion/drake) ⭐ 4,155 | 🐛 655 | 🌐 C++ | 📅 2026-08-19
* 🟢 [pinocchio](https://stack-of-tasks.github.io/pinocchio/) - Fast and flexible algorithms for rigid-body dynamics with analytical derivatives. [⭐ 3.5k](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,662 | 🐛 107 | 🌐 C++ | 📅 2026-08-11
...
* 🟢 LeRobot - Pretrained models, datasets, and simulation environments for real-world robotics in PyTorch. [⭐ 25.4k](https://github.com/huggingface/lerobot) ⭐ 26,755 | 🐛 805 | 🌐 Python | 📅 2026-08-19
...
* 🟢 OCS2 - Efficient continuous and discrete time optimal control implementation. [⭐ 1.5k](https://github.com/leggedrobotics/ocs2) ⭐ 1,497 | 🐛 54 | 🌐 C++ | 📅 2026-07-20
...
* 🟢 [Ruckig](https://github.com/pantor/ruckig) ⭐ 1,342 | 🐛 29 | 🌐 C++ | 📅 2026-07-15 - Real-time, time-optimal and jerk-constrained online trajectory generation. [⭐ 1.3k](https://github.com/pantor/ruckig) ⭐ 1,342 | 🐛 29 | 🌐 C++ | 📅 2026-07-15
...
* 🔴 [towr](http://wiki.ros.org/towr) - A light-weight, Eigen-based C++ library for trajectory optimization for legged robots. [⭐ 1.1k](https://github.com/ethz-adrl/towr) ⭐ 1,077 | 🐛 27 | 🌐 C++ | 📅 2023-04-17
...
* 🟢 [CasADi](https://github.com/casadi/casadi/wiki) ⭐ 2,273 | 🐛 739 | 🌐 C++ | 📅 2026-08-17 - Symbolic framework for algorithmic differentiation and numeric optimization. [⭐ 2.2k](https://github.com/casadi/casadi) ⭐ 2,273 | 🐛 739 | 🌐 C++ | 📅 2026-08-17
...
* 🟢 [CleanRL](https://github.com/vwxyzjn/cleanrl) ⭐ 10,290 | 🐛 109 | 🌐 Python | 📅 2026-04-20 - Single-file implementations of deep reinforcement learning algorithms. [⭐ 10k](https://github.com/vwxyzjn/cleanrl) ⭐ 10,290 | 🐛 109 | 🌐 Python | 📅 2026-04-20
* 🟢 [Isaac Lab](https://isaac-sim.github.io/IsaacLab) - GPU-accelerated open-source framework for robot learning built on NVIDIA Isaac Sim. [⭐ 7.5k](https://github.com/isaac-sim/IsaacLab) ⭐ 7,918 | 🐛 780 | 🌐 Python | 📅 2026-08-19
* 🟢 [Brax](https://github.com/google/brax) ⭐ 3,220 | 🐛 113 | 🌐 Jupyter Notebook | 📅 2026-08-06 - Massively parallel differentiable rigid body physics engine in JAX for robotics and RL. [⭐ 3.2k](https://github.com/google/brax) ⭐ 3,220 | 🐛 113 | 🌐 Jupyter Notebook | 📅 2026-08-06
...
* 🔴 ORB-SLAM2 - Real-time SLAM library for Monocular, Stereo and RGB-D cameras. [⭐ 10.2k](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,213 | 🐛 805 | 🌐 C++ | 📅 2024-05-15
...
* 🟢 GTSAM - Smoothing and mapping (SAM) in robotics and vision. [⭐ 3.6k](https://github.com/borglab/gtsam) ⭐ 3,640 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2026-08-19
...
* 🟢 [ViSP](http://visp.inria.fr/) - Visual Servoing Platform. [⭐ 893](https://github.com/lagadic/visp) ⭐ 908 | 🐛 3 | 🌐 C++ | 📅 2026-08-19
...
* 🟢 [MuJoCo Menagerie](https://github.com/google-deepmind/mujoco_menagerie) ⭐ 3,840 | 🐛 49 | 🌐 Python | 📅 2026-08-09 - Collection of well-tuned MuJoCo models for research and development. [⭐ 3.6k](https://github.com/google-deepmind/mujoco_menagerie) ⭐ 3,840 | 🐛 49 | 🌐 Python | 📅 2026-08-09
...
* 🟢 [Kratos](http://www.cimne.com/kratos/) - Framework for building parallel multi-disciplinary simulation software. [⭐ 1.3k](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,316 | 🐛 742 | 🌐 C++ | 📅 2026-08-19
...
* 🟢 [CARLA](https://carla.org/) - Open-source simulator for autonomous driving research. [⭐ 14.1k](https://github.com/carla-simulator/carla) ⭐ 14,302 | 🐛 1,192 | 🌐 C++ | 📅 2026-08-19
* 🟢 [Webots](http://www.cyberbotics.com/) - Development environment to model, program, and simulate robots and mechanical systems. [⭐ 4.4k](https://github.com/cyberbotics/webots) ⭐ 4,563 | 🐛 229 | 🌐 C++ | 📅 2026-08-18
* 🟢 [Isaac Sim](https://developer.nvidia.com/isaac/sim) - NVIDIA's GPU-accelerated robotics simulation platform with PhysX 5 and RTX rendering. [⭐ 3.6k](https://github.com/isaac-sim/IsaacSim) ⭐ 3,911 | 🐛 56 | 🌐 Python | 📅 2026-07-02
...
* 🟢 [Gazebo Sim](https://gazebosim.org/) - Open source robotics simulator (formerly Ignition Gazebo). [⭐ 1.4k](https://github.com/gazebosim/gz-sim) ⭐ 1,451 | 🐛 631 | 🌐 C++ | 📅 2026-08-19
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,070 | 🐛 26 | 🌐 Python | 📅 2026-08-11 - Curated list of machine learning frameworks, libraries, and software.
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,324 | 🐛 50 | 🌐 Python | 📅 2026-08-17 - Python sample codes for robotics algorithms.
* [Awesome Deep Learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,778 | 🐛 85 | 📅 2025-05-26 - Curated list of deep learning tutorials, projects, and communities.
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,504 | 🐛 91 | 📅 2024-05-17 - Curated list of computer vision resources.
* [Awesome Artificial Intelligence](https://github.com/owainlewis/awesome-artificial-intelligence) ⭐ 15,899 | 🐛 68 | 🌐 Python | 📅 2026-08-15 - Curated list of AI courses, books, video lectures, and papers.
...
* [Robotics Coursework](https://github.com/mithi/robotics-coursework) ⭐ 5,125 | 🐛 3 | 📅 2026-05-11 - A list of robotics courses you can take online.
...
Contributions are very welcome! Please read the [contribution guidelines](https://github.com/jslee02/awesome-robotics-libraries/blob/main/CONTRIBUTING.md) ⭐ 3,018 | 🐛 14 | 🌐 Python | 📅 2026-08-06 first. Also, please feel free to report any error.
